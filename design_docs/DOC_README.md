...
| [2026-07-09_worldbuilding_generation_plan.md](2026-07-09_worldbuilding_generation_plan.md) | Plan: hidden modifiers, generated items/NPCs/maps/world facts, custom world laws, storylets, and campaign-scale generation. Establishes the ladder from hidden item modifiers to editable world/campaign drafts |
