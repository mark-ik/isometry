...
| [2026-07-09_worldbuilding_generation_plan.md](2026-07-09_worldbuilding_generation_plan.md) | Plan: hidden modifiers, generated items/NPCs/maps/world facts, custom world laws, storylets, and campaign-scale generation. W0a: two-store secrets, transactional host reveal/recovery, WorldFact journal, Muniment/redb persistence. W0b: versioned public/private/Codicil checkpoint and fresh-host restore landed. W1a: typed public inventories, equipped items, hidden-modifier reveal, and sheet projection. W1b: effective-sheet mechanics and public appearance-layer CSS. W1c: host-side SRD add/equip/unequip. W1d: atomic host transfer landed; stacks and owner permissions remain. W2a: typed proposals, deterministic host entropy, locks, bounded Piccolo execution, fixtures, and host-only commit-result ledger. W2b: versioned pack manifest, contained declared assets, namespaced generator ids, and demo pack fixture command. W2c: host-only demo preview with reroll, visible lock, discard, and ordinary-event commit. W2d: tagged structured Lua request input. Proposal lowering, pack discovery, typed Lua output, content hashes/signatures, and campaign-pool casting remain. |
| [2026-07-09_shared_authority_and_collaborative_building_plan.md](2026-07-09_shared_authority_and_collaborative_building_plan.md) | Design record: shared hosting and DM-less play without CRDTs (tier 1 host handoff = near-term candidate; tier 2 turn-as-leader mechanical authority; tier 3 app-run campaigns with commit-reveal dice + sealed audited secrets). The GM is whoever holds edit mode (three replication rings: public log, GM ring, whispers). The current SerVal bridge is an Armillary actor. Three modes: edit / creative (graph-tending worldbuilding game: attachment rules, gap prompts, palette/veto) / survival. Collaborative building: multiplayer preview table, draft channel, player-declared truths, tombstone retraction |
